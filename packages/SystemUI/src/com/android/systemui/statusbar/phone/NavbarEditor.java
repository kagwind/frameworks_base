...
public class NavbarEditor implements View.OnTouchListener {
    ...
    protected void updateKeys() {
        ...
        boolean mButtonAutopadding = Settings.System.getInt(mContext.getContentResolver(),
        ...
        for (int i = 0; i < BUTTON_IDS.length; i++) {
            ...
            if ((button != NAVBAR_EMPTY || !mButtonAutopadding) && !isSmallButton) {
                visibleCount++;
            }
        ...
        for (int v = 0; v < totalViews; v++) {
            ...
            if (nextInfo != null && currentInfo != null && currentInfo != NAVBAR_EMPTY) {
                if (nextInfo != NAVBAR_EMPTY || visibleCount > 1) {
                    ...
                    nextPadding.setVisibility(mButtonAutopadding ? View.GONE : View.VISIBLE);
                }
                visibleCount--;
            } else {
                nextPadding.setVisibility(mButtonAutopadding ? View.GONE : View.VISIBLE);
